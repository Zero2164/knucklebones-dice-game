...
function applyKnockout() {
    ...
    removed.forEach((rIdx, idx) => {
        ...
        setTimeout(() => {
            ...
            // 🔥 After the last removal + gravity finishes, update scores
            // We can approximate by checking if this is the last removed die
